...
const makeMessagesSocket = (config) => {
    ...
    const relayMsg = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
    ...
    return {
        ...
        sendMsg: async (jid, content, options = {}) => {
            ...
            if ('productMessage' in content) {
                ...
                return await relayMsg(jid, msg.message, {
            ...
            await relayMsg(jid, fullMsg.message, {
